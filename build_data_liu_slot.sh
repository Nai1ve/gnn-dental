...
python build_gnn_dataset_liu_external.py \
  ...
  --output-pt gnn_data/train_sin_arch4_edge_01_slot.pt \
  -confidence 0.1 \
  --iou-threshold 0.6 \
  --ios-threshold 0.8 \
  --k-arch 4 \
...
python build_gnn_dataset_liu_external.py \
  ...
  --output-pt gnn_data/val_sin_arch4_edge_01_slot.pt \
  -confidence 0.1 \
  --iou-threshold 0.6 \
  --ios-threshold 0.8 \
  --k-arch 4 \
...
python build_gnn_dataset_liu_external.py \
  ...
  --output-pt gnn_data/test_ccsw_liu_test_slot.pt \
  -confidence 0.1 \
  --iou-threshold 0.6 \
  --ios-threshold 0.8 \
  --k-arch 4 \
...
python build_gnn_dataset_liu_external.py \
  ...
  --output-pt gnn_data/test_ccsw_liu_exp_slot.pt \
  -confidence 0.1 \
  --iou-threshold 0.6 \
  --ios-threshold 0.8 \
  --k-arch 4 \
...
python build_gnn_dataset_liu_external.py \
  ...
  --output-pt gnn_data/test_ccsw_liu_exp_open_slot.pt \
  -confidence 0.1 \
  --iou-threshold 0.6 \
  --ios-threshold 0.8 \
  --k-arch 4 \
